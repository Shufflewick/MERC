...
Plans:
- [x] 59-01-PLAN.md -- Mao multi-sector wilderness militia distribution (AI + human + flow loop)
- [x] 59-02-PLAN.md -- Mussolini two-step militia place and spread (AI + human + flow loops)
- [x] 59-03-PLAN.md -- Pol Pot rebel sector militia with conditional MERC hire on combat loss
...
Plans:
- [x] 60-01-PLAN.md -- Hitler hire + persistent initiative target override (AI + human + combat.ts hook)
- [x] 60-02-PLAN.md -- Noriega militia conversion, placement, and conditional hire (AI + human + multi-step flow)
