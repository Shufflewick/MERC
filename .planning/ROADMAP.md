...
Plans:
- [x] 53-01-PLAN.md -- Verify barrier architecture with integration tests for combat, coordinated attack, and done preservation
...
Plans:
- [x] 54-01-PLAN.md -- FLOW-05 verification tests + AI rebel action batching (round tracking, action conditions, integration tests)
