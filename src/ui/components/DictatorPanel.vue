...
const isInActionFlow = computed(() => {
  ...
  const dictatorSpecificActions = ['playTactics', 'reinforce', 'castroBonusHire', 'kimBonusMilitia', 'maoBonusMilitia', 'mussoliniBonusMilitia', 'mussoliniSpreadMilitia', 'chooseKimBase', 'generalissimoPick', 'lockdownPlaceMilitia', 'gadafiBonusHire', 'stalinBonusHire', 'husseinBonusTactics', 'husseinBonusReinforce'];
...
const isSelectingSector = computed(() => {
  ...
  if (currentAction === 'castroBonusHire' || currentAction === 'kimBonusMilitia' || currentAction === 'maoBonusMilitia' || currentAction === 'mussoliniBonusMilitia' || currentAction === 'mussoliniSpreadMilitia' || currentAction === 'generalissimoPick' || currentAction === 'lockdownPlaceMilitia' || currentAction === 'gadafiBonusHire' || currentAction === 'stalinBonusHire') {
