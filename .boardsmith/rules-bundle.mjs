...
var MERCGame = class _MERCGame extends Game {
  ...
  constructor(options) {
    ...
    } else if (options.dictatorPlayerPosition !== void 0) {
  ...
  presets: [
    {
      ...
      players: [
        { color: "#e74c3c", isAI: false },
        // Red rebel (you)
        { color: "#95a5a6", isAI: true, aiLevel: "medium" }
        // Dictator AI (last)
      ]
    },
    {
      ...
      options: { dictator: "0" },
      players: [
        { color: "#95a5a6", isAI: false },
        // Dictator (you, player 1)
        { color: "#e74c3c", isAI: true, aiLevel: "medium" }
        // Red rebel AI
      ]
    },
    {
    ...
    },
    {
      ...
      players: [
        ...
        { color: "#3498db", isAI: false },
        // Blue rebel
        { color: "#27ae60", isAI: false },
        // Green rebel
        { color: "#95a5a6", isAI: true, aiLevel: "hard" }
        // Dictator AI (last)
      ]
    }
  ]
